...
const BUILTIN_FEATURES = [
  ...
  { key: "companies", label: "Bedrijven", description: "Organisaties (super admin)" },
  { key: "invites", label: "Uitnodigingen (super)", description: "Super admins uitnodigen" },
  { key: "djs", label: "DJ's", description: "DJ-beheer (module)" },
  { key: "audiologger", label: "Audiologger", description: "Audiologger" },
  { key: "videologger", label: "Videologger", description: "Videologger" },
  { key: "ai_prepper", label: "AI prepper", description: "AI-voorbereiding" },
  { key: "playlist_prep", label: "Playlist prep", description: "Playlist-voorbereiding" },
  { key: "traffic", label: "Traffic / verkeer", description: "Verkeersinformatie" },
  { key: "omni_import_export", label: "Omni import/export", description: "Import en export" },
  { key: "appbox", label: "Appbox", description: "Appbox-integratie" },
  { key: "studio_reservation", label: "Studio-reservering", description: "Studio boeken" },
