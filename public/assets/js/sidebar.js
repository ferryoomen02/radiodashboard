...
const iconBuilding = `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 21h18"/><path d="M5 21V7l8-4v18"/><path d="M19 21V11l-6-4"/><path d="M9 9v.01"/><path d="M9 12v.01"/><path d="M9 15v.01"/><path d="M9 18v.01"/></svg>`;
...
function buildNavInnerHtml(feats, role, enabled, current) {
  ...
  if (role === "SUPER_ADMIN" && enabled.has("companies")) {
    nav += navItem("/companies", "Bedrijven", iconBuilding, "companies", current);
  }
